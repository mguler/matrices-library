...
exports.MatrixInversionBareissImpl = void 0;
const Matrix_1 = require("../Matrix");
class MatrixInversionBareissImpl {
    inverse(matrix) {
        ...
        for (var y = 0, x = 0; y < m.length; x++, y++) {
            ...
            console.log(new Matrix_1.Matrix(m).toString());
            console.log(pivot);
        ...
        console.log(new Matrix_1.Matrix(m).toString());
        console.log(new Matrix_1.Matrix(i).toString());
        var determinant = m[m.length - 1][m.length - 1];
        if (determinant == 0) {
            throw new Error("Cannot inverse the matrix when determinant is equals to zero");
        }
        return new Matrix_1.Matrix(i);
    }
}
exports.MatrixInversionBareissImpl = MatrixInversionBareissImpl;
//# sourceMappingURL=MatrixInversionBareissImpl.js.map